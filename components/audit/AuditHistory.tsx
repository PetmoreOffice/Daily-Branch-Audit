    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      {audits.length === 0 ? (
        ...
        <div className="bg-white rounded-xl border border-audit-hairline shadow-sm overflow-hidden">
          ...
          <div className="px-4 py-2.5 bg-slate-50 border-t border-audit-hairline text-[11px] text-slate-400 font-medium">
                ...
                {(() => {
                  ...
                  return (
                    <div className="text-center px-4 py-2 rounded-xl" style={{ background: colors.bg }}>
                      ...
                      <div className={`text-[10px] font-bold ${colors.text}`}>{status}</div>
                    </div>
                  );
                })()}
                <button
                ...
                return (
                  <div key={idx} className="p-4 rounded-xl border border-slate-100 bg-slate-50 space-y-2.5">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className={`font-extrabold text-sm shrink-0 ${colors.text}`}>{item.score}<span className="text-[10px] text-slate-400 font-semibold">/{max}</span></span>
                    </div>
                    {/* Score progress bar */}
