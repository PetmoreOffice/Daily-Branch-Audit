...
export default function NewAuditWizard({ onSubmit, auditorName }: NewAuditWizardProps) {
 ...
 <div className="mb-6">
 <h1 className="text-2xl font-extrabold text-navy">เริ่มการตรวจประเมินสาขาใหม่</h1>
 ...
 <div className="w-8 h-8 rounded-full bg-audit-blue flex items-center justify-center text-white text-xs font-extrabold shrink-0">1</div>
 ...
 <div className="w-8 h-8 rounded-full bg-slate-300 flex items-center justify-center text-white text-xs font-extrabold shrink-0">2</div>
 <div className="flex-1">
 ...
 className="absolute -top-1.5 -right-1.5 w-4 h-4 bg-red-500 text-white rounded-full text-xs flex items-center justify-center shadow-sm hover:bg-red-600 transition"
 >
 ×
 </button>
 </div>
