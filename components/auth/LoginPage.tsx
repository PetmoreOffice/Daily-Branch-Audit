...
export default function LoginPage({ onLogin }: LoginPageProps) {
 ...
 <div>
 <div className="text-white font-extrabold text-lg">Daily Branch Audit</div>
 ...
 <div className="text-white font-extrabold text-base">Daily Branch Audit</div>
 </div>
 ...
 <div>
 <h3 className="text-base font-extrabold text-white">รีเซ็ตรหัสผ่าน</h3>
